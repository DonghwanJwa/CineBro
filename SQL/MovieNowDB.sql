...
movie_nameK VARCHAR2(20) NOT NULL	--영화이름
movie_nameE VARCHAR2(20) NOT NULL	--영화이름
movie_img	VARCHAR2(20) NOT NULL	--영화이미지
audience  	VARCHAR2(20) NOT NULL	--관람객 평점
criticism	VARCHAR2(20) NOT NULL	--평론가 평점
gerne 		VARCHAR2(20) NOT NULL	--영화장르(장르, 나라, 러닝타임, 개봉일)
director 	VARCHAR2(20) NOT NULL	--영화감독
actors	    VARCHAR2(20) NOT NULL	--영화배우
age			VARCHAR2(20) NOT NULL	--영화등급
people	    VARCHAR2(20) NOT NULL	--누적관객수

--영화 동영상 주소를 저장할 컬럼생성
teaser	      	VARCHAR2(40)    NOT NULL   --티져영상 URL
oneview		  	VARCHAR2(40)	NOT NULL   --예고편1 URL
twoview	      	VARCHAR2(40)	NOT NULL   --예고편2 URL
threeview	    VARCHAR2(40)	NOT NULL   --예고편3 URL
...
'C:\\Program Files\\Internet Explorer\\iexplore.exe\
"https://movie.naver.com/movie/bi/mi/mediaView.nhn?
code=178526&mid=42906#tab',
'C:\\Program Files\\Internet Explorer\\iexplore.exe\
https://movie.naver.com/movie/bi/mi/mediaView.nhn?code=
